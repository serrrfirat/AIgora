...
import { convertToOneLine, replaceAgentValues, lc, createOrUpdateJsonFile, defaultTwitterTemplate } from './helpers.ts';
import { AgentData } from "./interfaces.ts"
...
generateOrUpdateGladiatorData("Flamma", "a revolutionary gladiator very well versed in debate", "comrade, fighter, and unbeatable");
