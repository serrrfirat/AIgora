// How the Twitter posts should be created.
...
// What actions should be taken in Twitter.
...
// What the goals should be when debating.
...
// What are the facts used in the debate.
