      ...
      ws.onmessage = (event) => {
        ...
        try {
          ...
          setChatMessages((prev) =>
            sortMessagesByTimestamp([message, ...prev])
          );
        } catch (error) {
          ...
          <>
            ...
            <Card className="bg-[#1C2128] border-0">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ChevronDown
                    className={`w-5 h-5 transition-transform ${
                      expandedCards.bondingCurve ? "rotate-0" : "-rotate-90"
                    }`}
                  />
                </div>
              </div>
                    ...
                    <div className="w-full h-2 bg-gray-800 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor: bondingCurve?.isFulfilled
                            ? "#3FB950"
                            : "#2F81F7",
                        }}
                      />
            ...
            <Card className="bg-[#1C2128] border-0">
              ...
              >
                ...
                <ChevronDown
                  className={`w-5 h-5 transition-transform ${
                    expandedCards.debateInfo ? "rotate-0" : "-rotate-90"
                  }`}
                />
              </div>
            ...
            <Card className="bg-[#1C2128] border-0">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ChevronDown
                    className={`w-5 h-5 transition-transform ${
                      expandedCards.gladiators ? "rotate-0" : "-rotate-90"
                    }`}
                  />
                </div>
              </div>
