...
import { NominateGladiatorCard } from "./debate-details/NominateGladiatorCard";
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        {indexedGladiators.map((gladiator, index) => {
                          ...
                          const currentPrice =
                            Number(
                              gladiatorPrices?.[Number(gladiator.index)] || 0n
                            ) / Number(BASIS_POINTS);
                          const volume = gladiatorVolumes
                            ? formatEther(
                                gladiatorVolumes[Number(gladiator.index)]
                              )
                            : "0";
                      ...
                      <div className="space-y-6">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            if (
                              typeof selectedGladiator?.index === "undefined"
                            ) {
                              console.error(
                                "No gladiator selected or invalid index"
                              );
